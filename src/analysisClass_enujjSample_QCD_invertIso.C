...
void analysisClass::Loop()
{
  ...
  int eleInvertIso = getPreCutValue1("eleInvertIso"); 
  ...
  for (Long64_t jentry=0; jentry<nentries;jentry++) { // Begin of loop over events
	...
	if(isData==1) //------> DATA
	  {
		...
		else if( HLTResults->at( HLTPhoton30 ) 
			 && ElectronPt->at(v_idx_ele_PtCut_IDISO_noOverlap[0]) >30 
			 && ElectronPt->at(v_idx_ele_PtCut_IDISO_noOverlap[0]) <50 ) 
		  {
		    PassTrig = 1;
		    weight_HLT = HLTPrescales->at( HLTPhoton30 ); 
		  }
		...
		if( HLTPrescales->at( HLTPhoton30 ) == -1 )
		  HLTPrescales->at( HLTPhoton30 ) = 1 ; 
		// 	    cout << "30: " << HLTPrescales->at( HLTPhoton30 ) << " --> fired? " << HLTResults->at( HLTPhoton30 ) 
		// 		 << " , 50: " << HLTPrescales->at( HLTPhoton50 ) << " --> fired? " << HLTResults->at( HLTPhoton50 ) 
		// 		 << " , 70: " << HLTPrescales->at( HLTPhoton70 ) << " --> fired? " << HLTResults->at( HLTPhoton70 ) 
		// 		 << endl; 
		//	    cout << "ElectronPt->at(v_idx_ele_PtCut_IDISO_noOverlap[0]): " << ElectronPt->at(v_idx_ele_PtCut_IDISO_noOverlap[0]) << endl;
		...
		else if( HLTResults->at( HLTPhoton50 ) 
			 && ElectronPt->at(v_idx_ele_PtCut_IDISO_noOverlap[0])>50 
			 && ElectronPt->at(v_idx_ele_PtCut_IDISO_noOverlap[0])<70 )
		  {
		    PassTrig = 1;
		    weight_HLT = HLTPrescales->at( HLTPhoton50 ); 
		  }
      ...
      }//end require at least one electron to ask for trigger
    */
    ...
    */
    ...
    //     if( v_idx_ele_PtCut_IDISO_noOverlap.size()>=1 && PassTrig == 1)
    //       {
    // 	cout << "weight: " << weight_HLT << endl;
    // 	cout << "p1: " << p1 << endl; 
    // 	cout << "----------" << endl;
    //       }
    ...
    ///  Just fill all histograms assuming exactly 1 electron.
 ...
 // 1st ele and transverse mass enu
    ...
    if( v_idx_ele_PtCut_IDISO_noOverlap.size() >= 1 )
      {
	fillVariableWithValue( "Pt1stEle_IDISO_NoOvrlp", ElectronPt->at(v_idx_ele_PtCut_IDISO_noOverlap[0]), p1 );
	fillVariableWithValue( "Eta1stEle_IDISO_NoOvrlp", ElectronEta->at(v_idx_ele_PtCut_IDISO_noOverlap[0]), p1 );
	fillVariableWithValue( "mEta1stEle_IDISO_NoOvrlp", fabs(ElectronEta->at(v_idx_ele_PtCut_IDISO_noOverlap[0])), p1 );
        fillVariableWithValue( "minMETPt1stEle", min(thisMET, ElectronPt->at(v_idx_ele_PtCut_IDISO_noOverlap[0])), p1 );
       	//PAS Sept 2010
	fillVariableWithValue( "Pt1stEle_PAS", ElectronPt->at(v_idx_ele_PtCut_IDISO_noOverlap[0]), p1 );
	fillVariableWithValue( "Eta1stEle_PAS", ElectronEta->at(v_idx_ele_PtCut_IDISO_noOverlap[0]), p1 );
        fillVariableWithValue( "minMETPt1stEle_PAS", min(thisMET, ElectronPt->at(v_idx_ele_PtCut_IDISO_noOverlap[0])), p1 );
	fillVariableWithValue( "Phi1stEle_PAS", ElectronPhi->at(v_idx_ele_PtCut_IDISO_noOverlap[0]), p1 );
	...
	//Electron Charge
	fillVariableWithValue( "Charge1stEle_PAS", ElectronCharge->at(v_idx_ele_PtCut_IDISO_noOverlap[0]), p1 );
	...
	FillUserTH2D("h2_EToverPT_vs_ET_1stEle", ElectronPt->at(v_idx_ele_PtCut_IDISO_noOverlap[0]), EToverPT, p1 );
