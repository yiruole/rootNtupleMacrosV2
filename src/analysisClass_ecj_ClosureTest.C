...
void analysisClass::Loop()
{
  ...
  for (Long64_t jentry=0; jentry<nentries;jentry++) { // Begin of loop over events
    ...
    if (v_idx_sc_Iso.size()>=2) fillVariableWithValue("nEle_PtCut_IDISO_noOvrlp",v_idx_sc_Iso.size(), weight) ;
    ...
    //TwoEleOnly
    fillVariableWithValue( "nJet_TwoEleOnly_All", v_idx_jet_PtCut_noOverlap_ID.size() , weight) ;
    fillVariableWithValue( "nJet_TwoEleOnly_EtaCut", v_idx_jet_PtCut_noOverlap_ID_EtaCut.size(), weight ) ;
    //PAS June 2010
    fillVariableWithValue( "nJet_PAS_All", v_idx_jet_PtCut_noOverlap_ID.size(), weight ) ;
    fillVariableWithValue( "nJet_PAS_EtaCut", v_idx_jet_PtCut_noOverlap_ID_EtaCut.size(), weight ) ;

    // MET
    //PAS June 2010
    fillVariableWithValue( "pfMET_PAS", PFMET->at(0), weight ) ;
    fillVariableWithValue( "tcMET_PAS", TCMET->at(0), weight ) ;
    fillVariableWithValue( "caloMET_PAS", CaloMET->at(0), weight ) ;

    //ele Pt
    if( v_idx_sc_Iso.size() >= 2 ) 
      {
	fillVariableWithValue( "Pt1stEle_IDISO_NoOvrlp", SuperClusterPt->at(v_idx_sc_Iso[0]), weight );
	fillVariableWithValue( "Eta1stEle_IDISO_NoOvrlp", SuperClusterEta->at(v_idx_sc_Iso[0]), weight );
	fillVariableWithValue( "mEta1stEle_IDISO_NoOvrlp", fabs(SuperClusterEta->at(v_idx_sc_Iso[0])), weight );
	//PAS June 2010
	fillVariableWithValue( "Pt1stEle_PAS", SuperClusterPt->at(v_idx_sc_Iso[0]), weight );
	fillVariableWithValue( "Eta1stEle_PAS", SuperClusterEta->at(v_idx_sc_Iso[0]), weight );

	fillVariableWithValue( "Pt2ndEle_IDISO_NoOvrlp", SuperClusterPt->at(v_idx_sc_Iso[1]), weight );
	fillVariableWithValue( "Eta2ndEle_IDISO_NoOvrlp", SuperClusterEta->at(v_idx_sc_Iso[1]), weight );
	fillVariableWithValue( "mEta2ndEle_IDISO_NoOvrlp", fabs(SuperClusterEta->at(v_idx_sc_Iso[1])), weight );
	...
	//PAS June 2010
	fillVariableWithValue( "Pt2ndEle_PAS", SuperClusterPt->at(v_idx_sc_Iso[1]), weight );
	fillVariableWithValue( "Eta2ndEle_PAS", SuperClusterEta->at(v_idx_sc_Iso[1]), weight );
      }
...
// 	  CaloJetPt->at(v_idx_jet_PtCut_noOverlap_ID[1]);
	...
	fillVariableWithValue("sT_MLQ400", calc_sT, weight);       
	//PAS June 2010
	...
	calc_sTjet =
	  CaloJetPt->at(v_idx_jet_PtCut_noOverlap_ID[0]) + 
	  CaloJetPt->at(v_idx_jet_PtCut_noOverlap_ID[1]) ;
// 	fillVariableWithValue("sTjet_PAS", calc_sTjet, weight);
      }
	...
	jj = jet1+jet2;
	//PAS June 2010
// 	fillVariableWithValue("Mjj_PAS", jj.M(), weight);
      }
	...
	//TwoEleOnly
	fillVariableWithValue("Mee_TwoEleOnly", ee.M(), weight);
	fillVariableWithValue("Mee_presel", ee.M(), weight);
	//
	//PAS June 2010
...
// 	fillVariableWithValue("maxDeltaR_ej", maxDeltaR_ej, weight);
    ...
    fillVariableWithValue("nEle_HEEP", v_idx_ele_PtCut_IDISO_noOverlap.size(), weight);
