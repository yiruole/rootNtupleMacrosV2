...
File_preselection = GetFile("/home/santanas/Leptoquarks/data/output_fromAFS/enujj_analysis/330pb-1_enujjskim/output_cutTable_enujjSample_2011/analysisClass_enujjSample_2011_plots.root")
...
QCDscaleFactor    = 10 # no need to rescale anymore since we are using the HLT prescales (36/35.84 can be ignored)
...
samplesForStackHistos = ["OTHERBKG","TTbar_Madgraph","WJet_Madgraph"]
keysStack =             ["QCD multijet",otherBkgsKey,"t#bar{t}", "W/W* + jets"]

#samplesForHistos = ["LQenujj_M300", "LQenujj_M400"]
#keys             = ["LQ, M = 300 GeV", "LQ, M = 400 GeV"]
samplesForHistos = []
keys             = [""]
...
plot4.keys            = keys
plot4.xtit            = "min(p_{T} electron,MET) [GeV]"
plot4.ytit            = "Events"
plot4.ylog            = "yes"
plot4.rebin           = "var"
plot4.xmin            = 0
...
plot13_afterOtherDfCuts.xtit            = "#Delta#phi(MET,2nd jet) [rad.]"
