...
void analysisClass::Loop()
{
   ...
   CreateUserTH1D( "DR_Ele1Ele2_PAS"	   , 	100, 0, 10     ) ; 
   CreateUserTH1D( "minDR_EleJet_PAS"	   , 	100, 0, 10     ) ; 
   CreateUserTH1D( "minDR_ZJet_PAS"      ,  100, 0, 10     ) ; 
   CreateUserTH1D( "DR_ZJet1_PAS"        ,  100, 0, 10     ) ; 
   CreateUserTH1D( "DR_ZJet2_PAS"        ,  100, 0, 10     ) ; 
   ...
   if(do_roi_plots) {										     										 
     ...
     CreateUserTH1D( "minDR_ZJet_ROI"        ,  100, 0, 10     ) ; 
     CreateUserTH1D( "DR_ZJet1_ROI"        ,    100, 0, 10   ) ; 
     CreateUserTH1D( "DR_ZJet2_ROI"        ,    100, 0, 10   ) ; 
   ...
   if(doFinalSelections)
   {
     for (int i_lq_mass = 0; i_lq_mass < n_lq_mass ; ++i_lq_mass ) { 
       ...
       sprintf(plot_name, "DR_Ele1Jet1_LQ%d"            , lq_mass ); CreateUserTH1D ( plot_name, 100, 0, 10);
       ...
       sprintf(plot_name, "minDR_ZJet_LQ%d"          , lq_mass ); CreateUserTH1D( plot_name ,    100, 0, 10     ) ; 
       sprintf(plot_name, "DR_ZJet1_LQ%d"            , lq_mass ); CreateUserTH1D( plot_name ,    100, 0, 10     ) ; 
       sprintf(plot_name, "DR_ZJet2_LQ%d"            , lq_mass ); CreateUserTH1D( plot_name ,    100, 0, 10     ) ; 
       // checking electrons
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
     ...
     //--------------------------------------------------------------------------
     // Get information about gen-level reweighting
     //--------------------------------------------------------------------------
