...
void analysisClass::Loop() {
  ...
  for (Long64_t jentry=0; jentry<nentries;jentry++) {
    ...
    fillVariableWithValue( "LooseEle2_Pt"         , LooseEle2_Pt          );
    fillVariableWithValue( "LooseEle1_PassID"     , LooseEle1_PassID      );
    fillVariableWithValue( "LooseEle2_PassID"     , LooseEle2_PassID      );
    ...
    if ( passedCut("nLooseEle_ptCut"       ) && 
	 ...
	 passedCut("LooseEle2_Pt"          ) && 
	 passedCut("LooseEle1_PassID"      ) && 
	 passedCut("LooseEle2_PassID"      ) && 
