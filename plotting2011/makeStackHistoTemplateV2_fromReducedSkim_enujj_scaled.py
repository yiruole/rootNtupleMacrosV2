...
File_preselection = GetFile("/afs/cern.ch/user/e/eberry/scratch0/LQDATA//enujj_analysis/enujj/scaled_output_cutTable_lq_enujj/analysisClass_lq_enujj_plots.root")
...
plots[-1].rebin = 2
plots[-1].ylog  = "yes"
plots[-1].xtit = "Mass (Electron, Jet) (Preselection) [GeV]"
...
plots[-1].rebin = 2
plots[-1].ylog  = "yes"
plots[-1].xtit = "M_{T} (Jet, PFMET) (Preselection) [GeV]"
...
plots.append ( makeDefaultPlot ( "Mej_LQ250", histoBaseName_userDef, samplesForHistos, keys, samplesForStackHistos, keysStack, sampleForDataHisto, zUncBand, makeRatio) )
plots[-1].rebin = mej_rebin
plots[-1].ymin = 1e-1
plots[-1].ymax = Mej_max
plots[-1].xtit = "M(ej) [GeV], LQ M=250 optimization"
plots[-1].ylog  = "yes"

plots.append ( makeDefaultPlot ( "Mej_LQ350",  histoBaseName_userDef, samplesForHistos, keys, samplesForStackHistos, keysStack, sampleForDataHisto, zUncBand, makeRatio) )
plots[-1].rebin = mej_rebin
plots[-1].ymin = 1e-1
plots[-1].ymax = Mej_max
plots[-1].xtit = "M(ej) [GeV], LQ M=350 optimization"
plots[-1].ylog  = "yes"

plots.append ( makeDefaultPlot ( "Mej_LQ400",  histoBaseName_userDef, samplesForHistos, keys, samplesForStackHistos, keysStack, sampleForDataHisto, zUncBand, makeRatio) )
plots[-1].rebin = mej_rebin
plots[-1].ymin = 1e-1
plots[-1].ymax = Mej_max
plots[-1].xtit = "M(ej) [GeV], LQ M=400 optimization"
plots[-1].ylog  = "yes"

plots.append ( makeDefaultPlot ( "Mej_LQ450",  histoBaseName_userDef, samplesForHistos, keys, samplesForStackHistos, keysStack, sampleForDataHisto, zUncBand, makeRatio) )
plots[-1].rebin = mej_rebin
plots[-1].ymin = 1e-1
plots[-1].ymax = Mej_max
plots[-1].xtit = "M(ej) [GeV], LQ M=450 optimization"
plots[-1].ylog  = "yes"

plots.append ( makeDefaultPlot ( "Mej_LQ500",  histoBaseName_userDef, samplesForHistos, keys, samplesForStackHistos, keysStack, sampleForDataHisto, zUncBand, makeRatio) )
plots[-1].rebin = mej_rebin
plots[-1].ymin = 1e-1
plots[-1].ymax = Mej_max
plots[-1].xtit = "M(ej) [GeV], LQ M=500 optimization"
plots[-1].ylog  = "yes"

plots.append ( makeDefaultPlot ( "Mej_LQ550",  histoBaseName_userDef, samplesForHistos, keys, samplesForStackHistos, keysStack, sampleForDataHisto, zUncBand, makeRatio) )
plots[-1].rebin = mej_rebin
plots[-1].ymin = 1e-1
plots[-1].ymax = Mej_max
plots[-1].xtit = "M(ej) [GeV], LQ M=550 optimization"
plots[-1].ylog  = "yes"

plots.append ( makeDefaultPlot ( "Mej_LQ600",  histoBaseName_userDef, samplesForHistos, keys, samplesForStackHistos, keysStack, sampleForDataHisto, zUncBand, makeRatio) )
plots[-1].rebin = mej_rebin
plots[-1].ymin = 1e-1
plots[-1].ymax = Mej_max
plots[-1].xtit = "M(ej) [GeV], LQ M=600 optimization"
plots[-1].ylog  = "yes"

plots.append ( makeDefaultPlot ( "Mej_LQ650",  histoBaseName_userDef, samplesForHistos, keys, samplesForStackHistos, keysStack, sampleForDataHisto, zUncBand, makeRatio) )
plots[-1].rebin = mej_rebin
plots[-1].ymin = 1e-1
plots[-1].ymax = Mej_max
plots[-1].xtit = "M(ej) [GeV], LQ M=650 optimization"
plots[-1].ylog  = "yes"

plots.append ( makeDefaultPlot ( "Mej_LQ750",  histoBaseName_userDef, samplesForHistos, keys, samplesForStackHistos, keysStack, sampleForDataHisto, zUncBand, makeRatio) )
plots[-1].rebin = mej_rebin
plots[-1].ymin = 1e-1
plots[-1].ymax = Mej_max
plots[-1].xtit = "M(ej) [GeV], LQ M=750 optimization"
plots[-1].ylog  = "yes"

plots.append ( makeDefaultPlot ( "Mej_LQ850",  histoBaseName_userDef, samplesForHistos, keys, samplesForStackHistos, keysStack, sampleForDataHisto, zUncBand, makeRatio) )
plots[-1].rebin = mej_rebin
plots[-1].ymin = 1e-1
plots[-1].ymax = Mej_max
plots[-1].xtit = "M(ej) [GeV], LQ M=850 optimization"
plots[-1].ylog  = "yes"


plots.append ( makeDefaultPlot ( "MTjnu_LQ250", histoBaseName_userDef, samplesForHistos, keys, samplesForStackHistos, keysStack, sampleForDataHisto, zUncBand, makeRatio) )
plots[-1].rebin = mtjnu_rebin
plots[-1].ymin = 1e-1
plots[-1].ymax = MTjnu_max
plots[-1].xtit = "M_{T}(j, PFMET) [GeV], LQ M=250 optimization"
plots[-1].ylog  = "yes"

plots.append ( makeDefaultPlot ( "MTjnu_LQ350",  histoBaseName_userDef, samplesForHistos, keys, samplesForStackHistos, keysStack, sampleForDataHisto, zUncBand, makeRatio) )
plots[-1].rebin = mtjnu_rebin
plots[-1].ymin = 1e-1
plots[-1].ymax = MTjnu_max
plots[-1].xtit = "M_{T}(j, PFMET) [GeV], LQ M=350 optimization"
plots[-1].ylog  = "yes"

plots.append ( makeDefaultPlot ( "MTjnu_LQ400",  histoBaseName_userDef, samplesForHistos, keys, samplesForStackHistos, keysStack, sampleForDataHisto, zUncBand, makeRatio) )
plots[-1].rebin = mtjnu_rebin
plots[-1].ymin = 1e-1
plots[-1].ymax = MTjnu_max
plots[-1].xtit = "M_{T}(j, PFMET) [GeV], LQ M=400 optimization"
plots[-1].ylog  = "yes"

plots.append ( makeDefaultPlot ( "MTjnu_LQ450",  histoBaseName_userDef, samplesForHistos, keys, samplesForStackHistos, keysStack, sampleForDataHisto, zUncBand, makeRatio) )
plots[-1].rebin = mtjnu_rebin
plots[-1].ymin = 1e-1
plots[-1].ymax = MTjnu_max
plots[-1].xtit = "M_{T}(j, PFMET) [GeV], LQ M=450 optimization"
plots[-1].ylog  = "yes"

plots.append ( makeDefaultPlot ( "MTjnu_LQ500",  histoBaseName_userDef, samplesForHistos, keys, samplesForStackHistos, keysStack, sampleForDataHisto, zUncBand, makeRatio) )
plots[-1].rebin = mtjnu_rebin
plots[-1].ymin = 1e-1
plots[-1].ymax = MTjnu_max
plots[-1].xtit = "M_{T}(j, PFMET) [GeV], LQ M=500 optimization"
plots[-1].ylog  = "yes"

plots.append ( makeDefaultPlot ( "MTjnu_LQ550",  histoBaseName_userDef, samplesForHistos, keys, samplesForStackHistos, keysStack, sampleForDataHisto, zUncBand, makeRatio) )
plots[-1].rebin = mtjnu_rebin
plots[-1].ymin = 1e-1
plots[-1].ymax = MTjnu_max
plots[-1].xtit = "M_{T}(j, PFMET) [GeV], LQ M=550 optimization"
plots[-1].ylog  = "yes"

plots.append ( makeDefaultPlot ( "MTjnu_LQ600",  histoBaseName_userDef, samplesForHistos, keys, samplesForStackHistos, keysStack, sampleForDataHisto, zUncBand, makeRatio) )
plots[-1].rebin = mtjnu_rebin
plots[-1].ymin = 1e-1
plots[-1].ymax = MTjnu_max
plots[-1].xtit = "M_{T}(j, PFMET) [GeV], LQ M=600 optimization"
plots[-1].ylog  = "yes"

plots.append ( makeDefaultPlot ( "MTjnu_LQ650",  histoBaseName_userDef, samplesForHistos, keys, samplesForStackHistos, keysStack, sampleForDataHisto, zUncBand, makeRatio) )
plots[-1].rebin = mtjnu_rebin
plots[-1].ymin = 1e-1
plots[-1].ymax = MTjnu_max
plots[-1].xtit = "M_{T}(j, PFMET) [GeV], LQ M=650 optimization"
plots[-1].ylog  = "yes"

plots.append ( makeDefaultPlot ( "MTjnu_LQ750",  histoBaseName_userDef, samplesForHistos, keys, samplesForStackHistos, keysStack, sampleForDataHisto, zUncBand, makeRatio) )
plots[-1].rebin = mtjnu_rebin
plots[-1].ymin = 1e-1
plots[-1].ymax = MTjnu_max
plots[-1].xtit = "M_{T}(j, PFMET) [GeV], LQ M=750 optimization"
plots[-1].ylog  = "yes"

plots.append ( makeDefaultPlot ( "MTjnu_LQ850",  histoBaseName_userDef, samplesForHistos, keys, samplesForStackHistos, keysStack, sampleForDataHisto, zUncBand, makeRatio) )
plots[-1].rebin = mtjnu_rebin
plots[-1].ymin = 1e-1
plots[-1].ymax = MTjnu_max
plots[-1].xtit = "M_{T}(j, PFMET) [GeV], LQ M=850 optimization"
plots[-1].ylog  = "yes"


plots.append ( makeDefaultPlot ( "sT_LQ250", histoBaseName_userDef, samplesForHistos, keys, samplesForStackHistos, keysStack, sampleForDataHisto, zUncBand, makeRatio) )
plots[-1].rebin = st_rebin
plots[-1].ymin = 1e-1
plots[-1].ymax = sT_max
...
plots.append ( makeDefaultPlot ( "sT_LQ350",  histoBaseName_userDef, samplesForHistos, keys, samplesForStackHistos, keysStack, sampleForDataHisto, zUncBand, makeRatio) )
plots[-1].rebin = st_rebin
plots[-1].ymin = 1e-1
plots[-1].ymax = sT_max
...
plots.append ( makeDefaultPlot ( "sT_LQ400",  histoBaseName_userDef, samplesForHistos, keys, samplesForStackHistos, keysStack, sampleForDataHisto, zUncBand, makeRatio) )
plots[-1].rebin = st_rebin
plots[-1].ymin = 1e-1
plots[-1].ymax = sT_max
...
plots.append ( makeDefaultPlot ( "sT_LQ450",  histoBaseName_userDef, samplesForHistos, keys, samplesForStackHistos, keysStack, sampleForDataHisto, zUncBand, makeRatio) )
plots[-1].rebin = st_rebin
plots[-1].ymin = 1e-1
plots[-1].ymax = sT_max
...
plots.append ( makeDefaultPlot ( "sT_LQ500",  histoBaseName_userDef, samplesForHistos, keys, samplesForStackHistos, keysStack, sampleForDataHisto, zUncBand, makeRatio) )
plots[-1].rebin = st_rebin
plots[-1].ymin = 1e-1
plots[-1].ymax = sT_max
...
plots.append ( makeDefaultPlot ( "sT_LQ550",  histoBaseName_userDef, samplesForHistos, keys, samplesForStackHistos, keysStack, sampleForDataHisto, zUncBand, makeRatio) )
plots[-1].rebin = st_rebin
plots[-1].ymin = 1e-1
plots[-1].ymax = sT_max
...
plots.append ( makeDefaultPlot ( "sT_LQ600",  histoBaseName_userDef, samplesForHistos, keys, samplesForStackHistos, keysStack, sampleForDataHisto, zUncBand, makeRatio) )
plots[-1].rebin = st_rebin
plots[-1].ymin = 1e-1
plots[-1].ymax = sT_max
...
plots.append ( makeDefaultPlot ( "sT_LQ650",  histoBaseName_userDef, samplesForHistos, keys, samplesForStackHistos, keysStack, sampleForDataHisto, zUncBand, makeRatio) )
plots[-1].rebin = st_rebin
plots[-1].ymin = 1e-1
plots[-1].ymax = sT_max
...
plots.append ( makeDefaultPlot ( "sT_LQ750",  histoBaseName_userDef, samplesForHistos, keys, samplesForStackHistos, keysStack, sampleForDataHisto, zUncBand, makeRatio) )
plots[-1].rebin = st_rebin
plots[-1].ymin = 1e-1
plots[-1].ymax = sT_max
...
plots.append ( makeDefaultPlot ( "sT_LQ850",  histoBaseName_userDef, samplesForHistos, keys, samplesForStackHistos, keysStack, sampleForDataHisto, zUncBand, makeRatio) )
plots[-1].rebin = st_rebin
plots[-1].ymin = 1e-1
plots[-1].ymax = sT_max
...
plots.append ( makeDefaultPlot ( "MET_LQ250", histoBaseName_userDef, samplesForHistos, keys, samplesForStackHistos, keysStack, sampleForDataHisto, zUncBand, makeRatio) )
plots[-1].rebin = met_rebin
plots[-1].ymin = 1e-1
plots[-1].ymax = MET_max
plots[-1].xtit = "MET [GeV], LQ M=250 optimization"
plots[-1].ylog  = "yes"

plots.append ( makeDefaultPlot ( "MET_LQ350",  histoBaseName_userDef, samplesForHistos, keys, samplesForStackHistos, keysStack, sampleForDataHisto, zUncBand, makeRatio) )
plots[-1].rebin = met_rebin
plots[-1].ymin = 1e-1
plots[-1].ymax = MET_max
plots[-1].xtit = "MET [GeV], LQ M=350 optimization"
plots[-1].ylog  = "yes"

plots.append ( makeDefaultPlot ( "MET_LQ400",  histoBaseName_userDef, samplesForHistos, keys, samplesForStackHistos, keysStack, sampleForDataHisto, zUncBand, makeRatio) )
plots[-1].rebin = met_rebin
plots[-1].ymin = 1e-1
plots[-1].ymax = MET_max
plots[-1].xtit = "MET [GeV], LQ M=400 optimization"
plots[-1].ylog  = "yes"

plots.append ( makeDefaultPlot ( "MET_LQ450",  histoBaseName_userDef, samplesForHistos, keys, samplesForStackHistos, keysStack, sampleForDataHisto, zUncBand, makeRatio) )
plots[-1].rebin = met_rebin
plots[-1].ymin = 1e-1
plots[-1].ymax = MET_max
plots[-1].xtit = "MET [GeV], LQ M=450 optimization"
plots[-1].ylog  = "yes"

plots.append ( makeDefaultPlot ( "MET_LQ500",  histoBaseName_userDef, samplesForHistos, keys, samplesForStackHistos, keysStack, sampleForDataHisto, zUncBand, makeRatio) )
plots[-1].rebin = met_rebin
plots[-1].ymin = 1e-1
plots[-1].ymax = MET_max
plots[-1].xtit = "MET [GeV], LQ M=500 optimization"
plots[-1].ylog  = "yes"

plots.append ( makeDefaultPlot ( "MET_LQ550",  histoBaseName_userDef, samplesForHistos, keys, samplesForStackHistos, keysStack, sampleForDataHisto, zUncBand, makeRatio) )
plots[-1].rebin = met_rebin
plots[-1].ymin = 1e-1
plots[-1].ymax = MET_max
plots[-1].xtit = "MET [GeV], LQ M=550 optimization"
plots[-1].ylog  = "yes"

plots.append ( makeDefaultPlot ( "MET_LQ600",  histoBaseName_userDef, samplesForHistos, keys, samplesForStackHistos, keysStack, sampleForDataHisto, zUncBand, makeRatio) )
plots[-1].rebin = met_rebin
plots[-1].ymin = 1e-1
plots[-1].ymax = MET_max
plots[-1].xtit = "MET [GeV], LQ M=600 optimization"
plots[-1].ylog  = "yes"

plots.append ( makeDefaultPlot ( "MET_LQ650",  histoBaseName_userDef, samplesForHistos, keys, samplesForStackHistos, keysStack, sampleForDataHisto, zUncBand, makeRatio) )
plots[-1].rebin = met_rebin
plots[-1].ymin = 1e-1
plots[-1].ymax = MET_max
plots[-1].xtit = "MET [GeV], LQ M=650 optimization"
plots[-1].ylog  = "yes"

plots.append ( makeDefaultPlot ( "MET_LQ750",  histoBaseName_userDef, samplesForHistos, keys, samplesForStackHistos, keysStack, sampleForDataHisto, zUncBand, makeRatio) )
plots[-1].rebin = met_rebin
plots[-1].ymin = 1e-1
plots[-1].ymax = MET_max
plots[-1].xtit = "MET [GeV], LQ M=750 optimization"
plots[-1].ylog  = "yes"

plots.append ( makeDefaultPlot ( "MET_LQ850",  histoBaseName_userDef, samplesForHistos, keys, samplesForStackHistos, keysStack, sampleForDataHisto, zUncBand, makeRatio) )
plots[-1].rebin = met_rebin
plots[-1].ymin = 1e-1
plots[-1].ymax = MET_max
plots[-1].xtit = "MET [GeV], LQ M=850 optimization"
plots[-1].ylog  = "yes"
...
c = TCanvas()
fileps = "allPlots_enujj_scaled_analysis.ps" 
