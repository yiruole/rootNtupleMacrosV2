...
File_preselection = GetFile("/afs/cern.ch/user/e/eberry/scratch0/LQDATA//eejj_analysis/QCDClosureTest_cej_DataAndMC/output_cutTable_lq_QCDClosureTest_cej_DataAndMC/analysisClass_lq_eejj_QCDClosureTest_plots.root")
