...
File_preselection = GetFile("/afs/cern.ch/user/e/eberry/scratch0/LQDATA//eejj_analysis/QCDClosureTest_cej_DataAndMC/output_cutTable_lq_QCD_FakeRateClosureTest_cej_DataAndMC/analysisClass_lq_QCD_FakeRateClosureTest_plots.root")
...
plots.append ( makeDefaultPlot ( "sT_eej"	 ,  histoBaseName, samplesForHistos, keys, samplesForStackHistos, keysStack, sampleForDataHisto, zUncBand, makeRatio) )
...
fileps = "allPlots_QCDClosureTest_cej_DataAndMC.ps" 
