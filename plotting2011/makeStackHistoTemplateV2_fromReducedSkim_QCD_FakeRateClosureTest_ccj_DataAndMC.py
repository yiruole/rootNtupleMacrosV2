...
File_preselection = GetFile("/afs/cern.ch/user/e/eberry/scratch0/LQDATA//eejj_analysis/QCDClosureTest_ccj_DataAndMC/output_cutTable_lq_QCD_FakeRateClosureTest_ccj_DataAndMC/analysisClass_lq_QCD_FakeRateClosureTest_plots.root")
