...
void analysisClass::Loop()
{
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
     ...
     if ( nMuon_Ana >= 1) muon.SetPtEtaPhiM       ( Muon1_Pt       , Muon1_Eta       , Muon1_Phi       , 0.0 );
	 ...
	 if ( nJet_Ana >= 2 ){
	   FillUserTH1D("Pt2ndJet_PAS"     , Jet2_Pt          , pileup_weight * min_prescale * fakeRateEffective ) ;
	   FillUserTH1D("Eta2ndJet_PAS"    , Jet2_Eta         , pileup_weight * min_prescale * fakeRateEffective ) ;
	   FillUserTH1D("Phi2ndJet_PAS"	   , Jet2_Phi         , pileup_weight * min_prescale * fakeRateEffective ) ;
	   ...
	   FillUserTH1D("sTjet_PAS"        , Jet1_Pt + Jet2_Pt, pileup_weight * min_prescale * fakeRateEffective ) ;
