   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
     ...
     */
	 ...
	 if    ( M_e1j2_new < M_e2j1_new ) M_ej_min = M_e1j2_new;
       ...
       fillVariableWithValue("sT_eejj_opt", sT_eejj_new , efficiency_weight   );
       fillVariableWithValue("M_e1e2_opt" , M_e1e2_new  , efficiency_weight   );
       fillVariableWithValue("Mej_min_opt", M_ej_min    , efficiency_weight   );
     }      
