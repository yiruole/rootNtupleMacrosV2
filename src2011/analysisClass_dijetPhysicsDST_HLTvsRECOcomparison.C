...
void analysisClass::Loop()
{
  ...
  TH1D *h_FirstMismatch_HLT1_RECO0 = new TH1D ("h_FirstMismatch_HLT1_RECO0","h_FirstMismatch_HLT1_RECO0",6,-0.5,5.5);
  ...
  h_FirstMismatch_HLT1_RECO0->GetXaxis()->SetBinLabel(6,"DEtaJJ");
  ...
  TH1D *h_FirstMismatch_HLT0_RECO1 = new TH1D ("h_FirstMismatch_HLT0_RECO1","h_FirstMismatch_HLT0_RECO1",6,-0.5,5.5);
  ...
  h_FirstMismatch_HLT0_RECO1->GetXaxis()->SetBinLabel(6,"DEtaJJ");
  ...
  //for (Long64_t jentry=0; jentry<1000;jentry++) { // Begin of loop over events
    ...
    // 1st jet 
    if( v_idx_hltpfjet_PtEtaCut_ID.size() >= 1 )        
      {
	fillVariableWithValue( "HLT_PFJet1_Pt", HLTPFJetCorrPt->at(v_idx_hltpfjet_PtEtaCut_ID[0]) );
	fillVariableWithValue( "HLT_PFJet1_Energy", HLTPFJetCorrEnergy->at(v_idx_hltpfjet_PtEtaCut_ID[0]) );
	fillVariableWithValue( "HLT_PFJet1_Eta", HLTPFJetEta->at(v_idx_hltpfjet_PtEtaCut_ID[0]) );
	fillVariableWithValue( "HLT_PFJet1_Phi", HLTPFJetPhi->at(v_idx_hltpfjet_PtEtaCut_ID[0]) );
      }

    if( v_idx_recopfjet_PtEtaCut_ID.size() >= 1 )        
      {
	fillVariableWithValue( "RECO_PFJet1_Pt", PFJetPt->at(v_idx_recopfjet_PtEtaCut_ID[0]) );
	fillVariableWithValue( "RECO_PFJet1_Energy", PFJetEnergy->at(v_idx_recopfjet_PtEtaCut_ID[0]) );
	fillVariableWithValue( "RECO_PFJet1_Eta", PFJetEta->at(v_idx_recopfjet_PtEtaCut_ID[0]) );
	fillVariableWithValue( "RECO_PFJet1_Phi", PFJetPhi->at(v_idx_recopfjet_PtEtaCut_ID[0]) );
      }

    // 2nd jet 
    if( v_idx_hltpfjet_PtEtaCut_ID.size() >= 2 )        
      {
	fillVariableWithValue( "HLT_PFJet2_Pt", HLTPFJetCorrPt->at(v_idx_hltpfjet_PtEtaCut_ID[1]) );
	fillVariableWithValue( "HLT_PFJet2_Energy", HLTPFJetCorrEnergy->at(v_idx_hltpfjet_PtEtaCut_ID[1]) );
	fillVariableWithValue( "HLT_PFJet2_Eta", HLTPFJetEta->at(v_idx_hltpfjet_PtEtaCut_ID[1]) );
	fillVariableWithValue( "HLT_PFJet2_Phi", HLTPFJetPhi->at(v_idx_hltpfjet_PtEtaCut_ID[1]) );

	if(debug)
	  {
	    if( HLTPFJetCorrPt->at(v_idx_hltpfjet_PtEtaCut_ID[1]) > HLTPFJetCorrPt->at(v_idx_hltpfjet_PtEtaCut_ID[0]) )
	      {
		cout << "diff , rel diff: " 
		     << HLTPFJetCorrPt->at(v_idx_hltpfjet_PtEtaCut_ID[1])  - HLTPFJetCorrPt->at(v_idx_hltpfjet_PtEtaCut_ID[0]) 
		     << " , " 
		     << ( HLTPFJetCorrPt->at(v_idx_hltpfjet_PtEtaCut_ID[1])  - HLTPFJetCorrPt->at(v_idx_hltpfjet_PtEtaCut_ID[0]) ) / HLTPFJetCorrPt->at(v_idx_hltpfjet_PtEtaCut_ID[0])
		     << endl;
	      }
	  }
      }

    if( v_idx_recopfjet_PtEtaCut_ID.size() >= 2 )        
      {
	fillVariableWithValue( "RECO_PFJet2_Pt", PFJetPt->at(v_idx_recopfjet_PtEtaCut_ID[1]) );
	fillVariableWithValue( "RECO_PFJet2_Energy", PFJetEnergy->at(v_idx_recopfjet_PtEtaCut_ID[1]) );
	fillVariableWithValue( "RECO_PFJet2_Eta", PFJetEta->at(v_idx_recopfjet_PtEtaCut_ID[1]) );
	fillVariableWithValue( "RECO_PFJet2_Phi", PFJetPhi->at(v_idx_recopfjet_PtEtaCut_ID[1]) );

	if(debug)
	  {
	    if( PFJetPt->at(v_idx_recopfjet_PtEtaCut_ID[1]) > PFJetPt->at(v_idx_recopfjet_PtEtaCut_ID[0]) )
    ...
    if( v_idx_hltpfjet_PtEtaCut_ID.size() >= 2 )  TwoHLTPFJets = true;
    if( v_idx_recopfjet_PtEtaCut_ID.size() >= 2 ) TwoRECOPFJets = true;

    if (TwoHLTPFJets)
      {
	TLorentzVector jet1, jet2, jj;
	jet1.SetPtEtaPhiE(HLTPFJetCorrPt->at(v_idx_hltpfjet_PtEtaCut_ID[0]),
			  HLTPFJetEta->at(v_idx_hltpfjet_PtEtaCut_ID[0]),
			  HLTPFJetPhi->at(v_idx_hltpfjet_PtEtaCut_ID[0]),
			  HLTPFJetCorrEnergy->at(v_idx_hltpfjet_PtEtaCut_ID[0]) );
	jet2.SetPtEtaPhiE(HLTPFJetCorrPt->at(v_idx_hltpfjet_PtEtaCut_ID[1]),
			  HLTPFJetEta->at(v_idx_hltpfjet_PtEtaCut_ID[1]),
			  HLTPFJetPhi->at(v_idx_hltpfjet_PtEtaCut_ID[1]),
			  HLTPFJetCorrEnergy->at(v_idx_hltpfjet_PtEtaCut_ID[1]) );
	jj = jet1+jet2;
    ...
    if (TwoRECOPFJets)
      {
	TLorentzVector jet1, jet2, jj;
	jet1.SetPtEtaPhiE(PFJetPt->at(v_idx_recopfjet_PtEtaCut_ID[0]),
			  PFJetEta->at(v_idx_recopfjet_PtEtaCut_ID[0]),
			  PFJetPhi->at(v_idx_recopfjet_PtEtaCut_ID[0]),
			  PFJetEnergy->at(v_idx_recopfjet_PtEtaCut_ID[0]) );
	jet2.SetPtEtaPhiE(PFJetPt->at(v_idx_recopfjet_PtEtaCut_ID[1]),
			  PFJetEta->at(v_idx_recopfjet_PtEtaCut_ID[1]),
			  PFJetPhi->at(v_idx_recopfjet_PtEtaCut_ID[1]),
			  PFJetEnergy->at(v_idx_recopfjet_PtEtaCut_ID[1]) );
	jj = jet1+jet2;
