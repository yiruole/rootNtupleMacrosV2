...
void analysisClass::Loop()
{
   ...
   int dataset  = (int) getPreCutValue1("dataset") ;
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
	 ...
	 if    ( M_e1j2 < M_e2j1 ) M_ej_min = M_e1j2;
       ...
       fillVariableWithValue("sT_eejj_opt", sT_eejj , gen_weight );
       fillVariableWithValue("M_e1e2_opt" , M_e1e2  , gen_weight );
       fillVariableWithValue("Mej_min_opt", M_ej_min, gen_weight );
