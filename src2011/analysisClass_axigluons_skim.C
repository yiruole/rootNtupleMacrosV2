...
void analysisClass::Loop()
{
  ...
  int do_lljj_skim = getPreCutValue1("do_lljj_skim");	
  int do_lnujj_skim = getPreCutValue1("do_lnujj_skim");	
...
//       }
	...
	TLorentzVector mumu;
	mumu = muon1 + muon2;	
	fillVariableWithValue("M_mu1mu2", mumu.M());	
	fillVariableWithValue("Pt_mu1mu2", mumu.Pt());	
      }      
    ...
    if( passedAllPreviousCuts("PassHBHENoiseFilter") 
 	&& ( 
	    ( passedCut("nEle") && passedCut("Ele1_Pt") && passedCut("Ele2_Pt"))
	    ||
	    ( passedCut("nMuon") && passedCut("Muon1_Pt") && passedCut("Muon2_Pt") )
	    )
	&& passedCut("nJet")
 	&& passedCut("Jet1_Pt")
	&& passedCut("Jet2_Pt")
