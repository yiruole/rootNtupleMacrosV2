...
void analysisClass::Loop()
{
   ...
   CreateUserTH1D( "mDPhi_METMuon1"	   , 	getHistoNBins("mDPhi_METMuon1"), getHistoMin("mDPhi_METMuon1"), getHistoMax("mDPhi_METMuon1")     ) ; 
   ...
   CreateUserTH2D( "DR_Muon1Jet2_vs_DR_Muon1Jet1"	   
		   , getHistoNBins("DR_Muon1Jet1"), getHistoMin("DR_Muon1Jet1"), getHistoMax("DR_Muon1Jet1")     
		   , getHistoNBins("DR_Muon1Jet2"), getHistoMin("DR_Muon1Jet2"), getHistoMax("DR_Muon1Jet2")     
		   ) ;   
   ...
   CreateUserTH1D( "MT_Muon1MET"	           , 	getHistoNBins("MT_Muon1MET"), getHistoMin("MT_Muon1MET"), getHistoMax("MT_Muon1MET")     ) ; 
   CreateUserTH1D( "Pt_Muon1MET"	           , 	getHistoNBins("Pt_Muon1MET"), getHistoMin("Pt_Muon1MET"), getHistoMax("Pt_Muon1MET")     ) ; 
   CreateUserTH1D( "Pt_j1j2"	           , 	getHistoNBins("Pt_j1j2"), getHistoMin("Pt_j1j2"), getHistoMax("Pt_j1j2")     ) ; 
   CreateUserTH1D( "sT_munujj"	           , 	getHistoNBins("sT_munujj"), getHistoMin("sT_munujj"), getHistoMax("sT_munujj")     ) ; 
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
     ...
     if ( nMuon >= 1 ) { 
       ...
       lepton.SetPtEtaPhiE(Muon1_Pt, Muon1_Eta, Muon1_Phi, Muon1_Energy);       
       lepton2D.SetMagPhi(Muon1_Pt, Muon1_Phi);
     ...
     if ( nMuon >= 1 ) { 
       fillVariableWithValue( "MT_Muon1MET"                   , MT_Muon1MET ) ;
       fillVariableWithValue( "Pt_Muon1MET"                   , Pt_Muon1MET ) ;
     }
     ...
     // DeltaPhi
     if ( nMuon >= 1 ) {      
       fillVariableWithValue( "mDPhi_METMuon1"                 , mDPhi_METMuon1 ) ;
     }
     if ( nJet >= 1 ) { 
     ...
     if ( passed_preselection ) { 
       ...
       FillUserTH1D( "MT_Muon1MET"	   , 	MT_Muon1MET    , event_weight);
       FillUserTH1D( "Pt_Muon1MET"	   , 	Pt_Muon1MET    , event_weight);
       FillUserTH1D( "Pt_j1j2"	           , 	Pt_j1j2       , event_weight);
       FillUserTH1D( "M_j1j2"	           , 	M_j1j2        , event_weight);
       FillUserTH1D( "sT_munujj"	   ,    sT_munujj      , event_weight);
       ...
       FillUserTH2D( "DR_Muon1Jet2_vs_DR_Muon1Jet1" , DR_Muon1Jet1 , DR_Muon1Jet2 , event_weight ); 	   
       FillUserTH1D( "DR_Jet1Jet2"	   , 	DR_Jet1Jet2   , event_weight);
       FillUserTH1D( "mDPhi_METMuon1"	   , 	mDPhi_METMuon1 , event_weight);
