...
File_preselection = GetFile(os.environ['LQDATA'] + "//eej_analysis/eej//scaled_output_cutTable_lq_eej/analysisClass_lq_eej_plots.root" )
File_QCD          = GetFile(os.environ['LQDATA'] + "//eej_analysis/eej_qcd//output_cutTable_lq_eej/analysisClass_lq_eej_QCD_plots.root")
...
def makeDefaultPlot ( variableName, histoBaseName, 
    ...
    plot.gif_folder        = "gif_eej_scaled/"
    plot.eps_folder        = "eps_eej_scaled/"
    plot.suffix            = "eej"
    plot.lumi_fb           = "19.5"
