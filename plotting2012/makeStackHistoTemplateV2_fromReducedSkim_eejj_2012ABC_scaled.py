...
File_preselection = GetFile(os.environ['LQDATA'] + "//eejj_analysis/eejj//scaled_output_cutTable_lq_eejj_2012ABC/analysisClass_lq_eejj_plots.root" )
File_QCD          = GetFile(os.environ['LQDATA'] + "//eejj_analysis/eejj_qcd//output_cutTable_lq_eejj_2012ABC/analysisClass_lq_eejj_QCD_plots.root")
...
def makeDefaultPlot ( variableName, histoBaseName, 
    ...
    plot.gif_folder        = "gif_eejj_2012ABC_scaled/"
    plot.eps_folder        = "eps_eejj_2012ABC_scaled/"
    plot.suffix            = "eejj"
    plot.lumi_fb           = "12.2"
...
fileps = "allPlots_eejj_2012ABC_scaled_analysis.pdf"
