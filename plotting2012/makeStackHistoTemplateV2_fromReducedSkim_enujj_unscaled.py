...
keysStack =             ["Other backgrounds" ,"QCD multijets" ,"t#bar{t}"      , "W + jets" ]
stackColorIndexes     = [ 9                  , 432            , 600            , 6             ]
stackFillStyleIds     = [ 3008               , 3005           , 3004           , 3006          ]
...
c = TCanvas()
fileps = "allPlots_enujj_analysis.pdf"
