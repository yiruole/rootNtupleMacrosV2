...
def makeDefaultPlot ( variableName, histoBaseName, 
    ...
    plot.gif_folder        = "gif_eejj_scaled_2012B/"
    plot.eps_folder        = "eps_eejj_scaled_2012B/"
    plot.pdf_folder        = "pdf_eejj_scaled_2012B/"
    plot.png_folder        = "png_eejj_scaled_2012B/"
    plot.suffix            = "eejj"
    plot.lumi_fb           = "4.43"
    plot.ymax  = 2000000
    plot.ymin  = 1e-1
...
fileps = "allPlots_eejj_2012B_scaled_electronQuality_analysis.pdf"
...
makeTOC ( "allPlots_eejj_2012B_scaled_electronQuality_analysis_toc.tex" , fileps, plots ) 
