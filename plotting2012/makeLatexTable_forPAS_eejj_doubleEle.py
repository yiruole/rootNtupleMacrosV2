...
dat_file_name     = os.environ['LQDATA'] + "//eejj_analysis/eejj_doubleEle//scaled_output_cutTable_lq_eejj/analysisClass_lq_eejj_doubleEle_tables.dat"
...
latex_file_name = "table_finalSelection_eejj_doubleEle.tex"
