...
File_preselection = GetFile(os.environ['LQDATA'] + "//eejj_analysis/eejj//scaled_output_cutTable_lq_eejj_2012B/analysisClass_lq_eejj_plots.root" )
File_TTBar        = GetFile(os.environ['LQDATA'] + "//eejj_analysis/eejj//scaled_output_cutTable_lq_eejj_2012B/analysisClass_lq_eejj_plots.root" )
File_QCD          = GetFile(os.environ['LQDATA'] + "//eejj_analysis/eejj_qcd//output_cutTable_lq_eejj_2012B/analysisClass_lq_eejj_QCD_plots.root")
...
def makeDefaultPlot ( variableName, histoBaseName, 
    ...
    plot.gif_folder        = "gif_eejj_scaled_finalOnly_2012B/"
    plot.eps_folder        = "eps_eejj_scaled_finalOnly_2012B/"
    plot.png_folder        = "png_eejj_scaled_finalOnly_2012B/"
    plot.pdf_folder        = "pdf_eejj_scaled_finalOnly_2012B/"
...
fileps = "allPlots_eejj_scaled_2012B_analysis_finalOnly.pdf"
