...
samplesForStackHistos_ZJets  = [ "TTbar_Madgraph", "Z0Jet_Madgraph", "Z1Jet_Madgraph", "Z2Jet_Madgraph", "Z3Jet_Madgraph", "Z4Jet_Madgraph" ]
samplesForStackHistos = samplesForStackHistos_other + samplesForStackHistos_ZJets

keysStack             = [ "QCD multijets", "Other backgrounds", "t#bar{t}"  ,  "Z/#gamma* + 0 jets" ,  "Z/#gamma* + 1 jets" ,  "Z/#gamma* + 2 jets" ,  "Z/#gamma* + 3 jets" ,  "Z/#gamma* + 4 jets"  ]
stackColorIndexes     = [ 432            , 9                  , 600         ,  kRed                 ,  kRed +2              ,  kRed -4              ,  kRed -5              ,  kRed -10              ]
stackFillStyleIds     = [ 3005           , 3008               , 3004        ,  3345                 ,  3345                 ,  3345                 ,  3345                 ,  3345                  ]
...
def makeDefaultPlot ( variableName, histoBaseName, 
    ...
    plot.gif_folder        = "gif_eejj_scaled_jetbinned/"
    plot.eps_folder        = "eps_eejj_scaled_jetbinned/"
    plot.suffix            = "eejj"
    plot.lumi_fb           = "19.5"
...
fileps = "allPlots_eejj_scaled_jetbinned_analysis.pdf"
