...
#            ystart=0.63
        ...
        legend.AddEntry(plot.histodata, "Data, 19.5 fb^{-1}","lp")
...
#            l.DrawLatex(xstart+hsize+0.02,ystart+vsize-0.13,"#intLdt = " + self.lint)
            ...
            l.DrawLatex(xstart-hsize+0.05,ystart+vsize-0.15,"#sqrt{s} = 8 TeV")
...
plots_inclusive.append ( makeDefaultPlot ( "Total_minPrescale", histoBaseName_userDef, samplesForHistos, keys, samplesForStackHistos, keysStack, sampleForDataHisto, zUncBand, makeRatio) )
plots_inclusive[-1].xtit            = "Minimum prescale"
...
plots_inclusive.append ( makeDefaultPlot ( "Total_pileupWeight", histoBaseName_userDef, samplesForHistos, keys, samplesForStackHistos, keysStack, sampleForDataHisto, zUncBand, makeRatio) )
plots_inclusive[-1].xtit            = "Pileup weight"
plots_inclusive[-1].ylog            = "yes"
plots_inclusive[-1].rebin           = 1
plots_inclusive[-1].ymin            = 0.0001
plots_inclusive[-1].ymax            = 10000000000000

plots_inclusive.append ( makeDefaultPlot ( "Total_Bar_nVertex_PAS", histoBaseName_userDef, samplesForHistos, keys, samplesForStackHistos, keysStack, sampleForDataHisto, zUncBand, makeRatio) )
plots_inclusive[-1].xtit            = "Number of vertices (Barrel, Denominator)"
plots_inclusive[-1].ylog            = "yes"
plots_inclusive[-1].rebin           = 1
plots_inclusive[-1].xmin            = -0.5
plots_inclusive[-1].xmax            = 100.05
plots_inclusive[-1].ymin            = 0.0001
plots_inclusive[-1].ymax            = 10000000000000


plots_inclusive.append ( makeDefaultPlot ( "Pass_Bar_nVertex_PAS", histoBaseName_userDef, samplesForHistos, keys, samplesForStackHistos, keysStack, sampleForDataHisto, zUncBand, makeRatio) )
plots_inclusive[-1].xtit            = "Number of vertices (Barrel, Numerator)"
plots_inclusive[-1].ylog            = "yes"
plots_inclusive[-1].rebin           = 1
plots_inclusive[-1].xmin            = -0.5
plots_inclusive[-1].xmax            = 100.05
...
plots_inclusive.append ( makeDefaultPlot ( "Total_Bar_hltPt1stEle_PAS"	         ,  histoBaseName_userDef, samplesForHistos, keys, samplesForStackHistos, keysStack, sampleForDataHisto, zUncBand, makeRatio) )
plots_inclusive[-1].xtit = "1st Electron HLT p_{T} (Barrel, Denominator) [GeV]"
plots_inclusive[-1].xmin = 0.
...
plots_inclusive.append ( makeDefaultPlot ( "Pass_Bar_hltPt1stEle_PAS"	         ,  histoBaseName_userDef, samplesForHistos, keys, samplesForStackHistos, keysStack, sampleForDataHisto, zUncBand, makeRatio) )
plots_inclusive[-1].xtit = "1st Electron HLT p_{T} (Barrel, Numerator) [GeV]"
plots_inclusive[-1].xmin = 0.
plots_inclusive[-1].xmax = 600.
plots_inclusive[-1].ymax = 2000000000000
plots_inclusive[-1].ymin = 1e-1
...
plots_inclusive.append ( makeDefaultPlot ( "Total_End1_hltPt1stEle_PAS"	         ,  histoBaseName_userDef, samplesForHistos, keys, samplesForStackHistos, keysStack, sampleForDataHisto, zUncBand, makeRatio) )
plots_inclusive[-1].xtit = "1st Electron HLT p_{T} (Endcap |#eta| < 2, Denominator) [GeV]"
plots_inclusive[-1].xmin = 0.
plots_inclusive[-1].xmax = 600.
plots_inclusive[-1].ymax = 2000000000000
plots_inclusive[-1].ymin = 1e-1
...
plots_inclusive.append ( makeDefaultPlot ( "Pass_End1_hltPt1stEle_PAS"	         ,  histoBaseName_userDef, samplesForHistos, keys, samplesForStackHistos, keysStack, sampleForDataHisto, zUncBand, makeRatio) )
plots_inclusive[-1].xtit = "1st Electron HLT p_{T} (Endcap |#eta| < 2, Numerator) [GeV]"
plots_inclusive[-1].xmin = 0.
plots_inclusive[-1].xmax = 600.
plots_inclusive[-1].ymax = 2000000000000
plots_inclusive[-1].ymin = 1e-1
...
plots_inclusive.append ( makeDefaultPlot ( "Total_End2_hltPt1stEle_PAS"	         ,  histoBaseName_userDef, samplesForHistos, keys, samplesForStackHistos, keysStack, sampleForDataHisto, zUncBand, makeRatio) )
plots_inclusive[-1].xtit = "1st Electron HLT p_{T} (Endcap |#eta| > 2, Denominator) [GeV]"
plots_inclusive[-1].xmin = 0.
plots_inclusive[-1].xmax = 600.
plots_inclusive[-1].ymax = 2000000000000
...
plots_inclusive.append ( makeDefaultPlot ( "Pass_End2_hltPt1stEle_PAS"	     ,  histoBaseName_userDef, samplesForHistos, keys, samplesForStackHistos, keysStack, sampleForDataHisto, zUncBand, makeRatio) )
plots_inclusive[-1].xtit = "1st Electron HLT p_{T} (Endcap |#eta| > 2, Numerator) [GeV]"
plots_inclusive[-1].xmin = 0.
plots_inclusive[-1].xmax = 600.
plots_inclusive[-1].ymax = 2000000000000
...
fileps_inclusive = "allPlots_QCDFakeRate_inclusive.pdf" 
fileps_1jet      = "allPlots_QCDFakeRate_1jet.pdf" 
fileps_2jet      = "allPlots_QCDFakeRate_2jet.pdf" 
fileps_3jet      = "allPlots_QCDFakeRate_3jet.pdf" 
