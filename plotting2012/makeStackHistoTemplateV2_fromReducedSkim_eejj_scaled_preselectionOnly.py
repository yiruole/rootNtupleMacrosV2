...
File_QCD          = GetFile(os.environ['LQDATA'] + "//eejj_analysis/eejj_qcd//output_cutTable_lq_eejj_preselectionOnly/analysisClass_lq_eejj_QCD_preselectionOnly_plots.root")
...
def makeDefaultPlot ( variableName, histoBaseName, 
    ...
    plot.gif_folder        = "gif_eejj_preselectionOnly_scaled/"
    plot.eps_folder        = "eps_eejj_preselectionOnly_scaled/"
    plot.suffix            = "eejj"
    plot.lumi_fb           = "19.5"
...
def makeDefaultPlot2D ( variableName, 
    ...
    plot.histosStack = ( generateHistoList( histoBaseName, samplesForStackHistosQCD   , variableName, File_QCD, QCDScale) + 
                         ...
                         generateHistoList( histoBaseName, samplesForStackHistos_ZJets, variableName, File_preselection )  ) 
    plot.histodata      = generateHisto( histoBaseName, sampleForDataHisto, variableName, File_preselection)
    plot.gif_folder     = "gif_eejj_scaled_finalOnly/"
    plot.eps_folder     = "eps_eejj_scaled_finalOnly/"
...
plots.append ( makeDefaultPlot2D ( "sT_vs_Mee" , histoBaseName2D_userDef, samplesForStackHistos, sampleForDataHisto ) )
plots[-1].xrebin = 10
plots[-1].yrebin = 10
plots[-1].xmin = 200
plots[-1].xmax = 2000
plots[-1].ymin = 0
plots[-1].ymax = 600
plots[-1].xtit = "s_{T}^{ee} (GeV) [Preselection]"
plots[-1].ytit = "M(ee) (GeV) [Preselection]"

plots.append ( makeDefaultPlot2D_Ratio ( "sT_vs_Mee" , histoBaseName2D_userDef, samplesForStackHistos, sampleForDataHisto ) )
plots[-1].xrebin = 10
plots[-1].yrebin = 10
plots[-1].xmin = 200
plots[-1].xmax = 2000
...
plots.append ( makeDefaultPlot2D_NSigma ( "sT_vs_Mee" , histoBaseName2D_userDef, samplesForStackHistos, sampleForDataHisto ) )
plots[-1].xrebin = 10
plots[-1].yrebin = 10
plots[-1].xmin = 200
plots[-1].xmax = 2000
...
fileps = "allPlots_eejj_scaled_preselectionOnly_analysis.pdf"
