...
void make_data_split_plot_ROI(){
  ...
  char save_name [200]; sprintf(save_name , "nEventsPassing_ROI.png");
  char hist_name [100]; sprintf(hist_name , "histo1D__DATA__split_ROI");
  ...
  char plot_title[100]; sprintf(plot_title, "Number of events in region of interest");
