...
def getScale (sample_name, lumi, n_events):
    xsection_file = open ("config/xsection_8TeV_2012A_ZScaled.txt","r")
...
dat_file_name     = os.environ['LQDATA'] + "//eejj_analysis/eejj//scaled_output_cutTable_lq_eejj_2012A/analysisClass_lq_eejj_tables.dat"
qcd_dat_file_name = os.environ['LQDATA'] + "//eejj_analysis/eejj_qcd//output_cutTable_lq_eejj_2012A/analysisClass_lq_eejj_QCD_tables.dat"
...
latex_file_name = "table_finalSelection_eejj_2012A.tex"
