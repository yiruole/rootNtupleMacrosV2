...
keysStack             = [ "QCD multijets", "Other backgrounds", "t#bar{t} (Data)"  ,  "Z/#gamma* + jets"  , "M_{LQ} = 700 GeV"]
...
def makeDefaultPlot ( variableName, histoBaseName, 
    ...
    plot.png_folder        = "png_eejj_scaled_finalOnly/"
    plot.pdf_folder        = "pdf_eejj_scaled_finalOnly/"
...
fileps = "allPlots_eejj_ttbarFromData_scaled_analysis_finalOnly.pdf"
