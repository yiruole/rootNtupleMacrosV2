...
#            l.DrawLatex(xstart-hsize-0.10,ystart+vsize-0.13,"#intLdt = " + self.lint)
        ...
        #-- end
        canvas.SaveAs("eps_QCDClosureTest_ContaminationTest/" + self.name + ".eps","eps")
        canvas.SaveAs("gif_QCDClosureTest_ContaminationTest/" + self.name + ".gif","gif")
...
File_preselection = GetFile(os.environ["LQDATA"]+"/eejj_analysis/QCDClosureTest_ccj_DataAndMC/output_cutTable_lq_QCD_FakeRateClosureTest_ccj_DataAndMC/analysisClass_lq_QCD_FakeRateClosureTest_plots.root")
...
plots.append ( makeDefaultPlot ( "M_e1e2"	 ,  histoBaseName, samplesForHistos, keys, samplesForStackHistos, keysStack, sampleForDataHisto, zUncBand, makeRatio) )
plots[-1].xtit = "M(ee) [GeV] (cut)"
plots[-1].ymax = 2000000
plots[-1].rebin = 1
plots[-1].ymin = 1e-1
plots[-1].ylog  = "yes"

plots.append ( makeDefaultPlot ( "sT_eej_200"	 ,  histoBaseName, samplesForHistos, keys, samplesForStackHistos, keysStack, sampleForDataHisto, zUncBand, makeRatio) )
plots[-1].xtit = "s_{T} [GeV] (cut)"
plots[-1].ymax = 2000000
plots[-1].rebin = 1
plots[-1].ymin = 1e-1
plots[-1].ylog  = "yes"
...
fileps = "allPlots_QCDClosureTest_ccj_DataAndMC.ps" 
