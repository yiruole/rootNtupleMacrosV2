...
def getScale (sample_name, lumi, n_events):
    xsection_file = open ("xsection_8TeV_2012_ZScaled_ttbarFromData.txt","r")
...
dat_file_name     = os.environ['LQDATA'] + "//eejj_analysis/eejj//scaled_ttbarFromData_output_cutTable_lq_eejj/analysisClass_lq_eejj_tables.dat"
