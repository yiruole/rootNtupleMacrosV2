...
File_TTBar        = GetFile(os.environ['LQDATA'] + "//eejj_analysis/eejj//scaled_output_cutTable_lq_eejj/analysisClass_lq_eejj_plots.root"     )
...
samplesForStackHistos_ZJets  = [ "ZJet_tarball_Madgraph" ]
...
def makeDefaultPlot ( variableName, histoBaseName, 
    ...
    plot.gif_folder        = "gif_eejj_ZJetTarball_scaled_finalOnly/"
    plot.eps_folder        = "eps_eejj_ZJetTarball_scaled_finalOnly/"
    plot.png_folder        = "png_eejj_ZJetTarball_scaled_finalOnly/"
    plot.pdf_folder        = "pdf_eejj_ZJetTarball_scaled_finalOnly/"
...
fileps = "allPlots_eejj_ZJetTarball_scaled_analysis_finalOnly.pdf"
