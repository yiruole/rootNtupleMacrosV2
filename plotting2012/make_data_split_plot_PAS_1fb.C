...
bool rescale = true;
double y_axis_minimum = 200.;
double y_axis_maximum = 500.;
...
void make_data_split_plot_PAS_1fb(){
  ...
  char save_name [200]; sprintf(save_name , "nEventsPassing_PAS_1fb.png");
  char hist_name [100]; sprintf(hist_name , "histo1D__DATA__split_1fb_PAS");
  ...
  if ( gStyle -> GetOptFit () != 0 ){
    ...
    st -> SetX1NDC ( 0.650862 );
    st -> SetY1NDC ( 0.730932 );
    st -> SetX2NDC ( 0.880747 );
    st -> SetY2NDC ( 0.879237 );
  }
  ...
  char plot_title[100]; sprintf(plot_title, "Number of events passing preselection");
