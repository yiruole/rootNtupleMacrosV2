...
File_preselection = GetFile(os.environ['LQDATA'] + "//eejj_analysis/eejj_doubleEle//scaled_output_cutTable_lq_eejj/analysisClass_lq_eejj_doubleEle_plots.root"     )
File_TTBar        = GetFile(os.environ['LQDATA'] + "//eejj_analysis/eejj_doubleEle//scaled_output_cutTable_lq_eejj/analysisClass_lq_eejj_doubleEle_plots.root"     )
...
keysStack             = [ "QCD multijets", "Other backgrounds", "t#bar{t}"  ,  "Z/#gamma* + jets"  , "M_{LQ} = 700 GeV"]
stackColorIndexes     = [ 432            , 9                  , 600         ,  kRed           , 8]
stackFillStyleIds     = [ 3005           , 3008               , 3005        ,  3004           , 0]
...
def makeDefaultPlot ( variableName, histoBaseName, 
    ...
    plot.gif_folder        = "gif_eejj_doubleEle_scaled_finalOnly/"
    plot.eps_folder        = "eps_eejj_doubleEle_scaled_finalOnly/"
    plot.png_folder        = "png_eejj_doubleEle_scaled_finalOnly/"
    plot.pdf_folder        = "pdf_eejj_doubleEle_scaled_finalOnly/"
...
fileps = "allPlots_eejj_doubleEle_scaled_analysis_finalOnly.pdf"
