...
File_preselection = GetFile(os.environ['LQDATA'] + "//eejj_analysis/eejj//scaled_output_cutTable_lq_eejj_2012A/analysisClass_lq_eejj_plots.root" )
File_QCD          = GetFile(os.environ['LQDATA'] + "//eejj_analysis/eejj_qcd//output_cutTable_lq_eejj_2012A/analysisClass_lq_eejj_QCD_plots.root")
...
def makeDefaultPlot ( variableName, histoBaseName, 
    ...
    plot.gif_folder        = "gif_eejj_scaled_2012A/"
    plot.eps_folder        = "eps_eejj_scaled_2012A/"
    plot.pdf_folder        = "pdf_eejj_scaled_2012A/"
    plot.png_folder        = "png_eejj_scaled_2012A/"
    plot.suffix            = "eejj"
    plot.lumi_fb           = "0.89"
    plot.ymax  = 2000000
    plot.ymin  = 1e-1
...
fileps = "allPlots_eejj_2012A_scaled_electronQuality_analysis.pdf"
...
makeTOC ( "allPlots_eejj_2012A_scaled_electronQuality_analysis_toc.tex" , fileps, plots ) 
