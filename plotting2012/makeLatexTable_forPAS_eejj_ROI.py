...
dat_file_name     = os.environ['LQDATA'] + "//eejj_analysis/eejj_ROI//output_cutTable_lq_eejj_ROI/analysisClass_lq_eejj_tables.dat"
qcd_dat_file_name = os.environ['LQDATA'] + "//eejj_analysis/eejj_qcd_ROI//output_cutTable_lq_eejj_ROI/analysisClass_lq_eejj_QCD_tables.dat"
