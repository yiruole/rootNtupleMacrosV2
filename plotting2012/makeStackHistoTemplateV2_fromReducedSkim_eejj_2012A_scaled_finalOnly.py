...
File_TTBar        = GetFile(os.environ['LQDATA'] + "//eejj_analysis/eejj//scaled_output_cutTable_lq_eejj_2012A/analysisClass_lq_eejj_plots.root" )
...
def makeDefaultPlot ( variableName, histoBaseName, 
    ...
    plot.png_folder        = "png_eejj_scaled_finalOnly_2012A/"
    plot.pdf_folder        = "pdf_eejj_scaled_finalOnly_2012A/"
...
fileps = "allPlots_eejj_scaled_2012A_analysis_finalOnly.pdf"
